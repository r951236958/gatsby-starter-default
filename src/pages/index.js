...
const IndexPage = () => (
  <Layout>
    ...
    <div className="flex item-center space-x-4 my-4">
      <Link
      ...
      <Link
        className="inline-flex h-10 py-2 px-4 text-teal-400 border border-teal-400 rounded-lg hover:bg-gray-100 hover:bg-opacity-10 hover:text-teal-300 hover:border-teal-500"
        to="/using-typescript/"
      >
